...
const Leaderboard = () => {
  ...
  return (
    <div className="px-4 lg:px-12 pt-10 pb-24">
      {/* Page Header */}
      <div className="text-center pb-6">
        <h1 className="text-3xl lg:text-5xl font-bold bg-gradient-to-r from-purple-500 via-pink-400 to-pink-500 text-transparent bg-clip-text">
